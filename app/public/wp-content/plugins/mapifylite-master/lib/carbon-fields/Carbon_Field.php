...
add_action('admin_enqueue_scripts', array('Carbon_Field', 'admin_hook_scripts'));
...
class Carbon_Field_Rich_Text extends Carbon_Field_Textarea {
	...
	function admin_init() {
		if ( !self::$attached_editor ) {
			...
			add_action('admin_enqueue_scripts', array('Carbon_Field_Rich_Text', 'admin_enqueue_scripts'));
