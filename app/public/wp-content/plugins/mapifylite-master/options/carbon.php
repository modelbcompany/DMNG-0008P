		...
		(function($){
			...
			$(document).ready(function(){
				...
				$select.change(function() {
					var $map = $('.carbon-map[data-name="_map_google_center"]');
	...
	(function($, $window, $document){
		$(document).ready(function(){
			...
			if ( $settingsContainer.length > 0 ) {
				...
				$settingsFieldContainer.find( '.help-text:first').hide();
					...
					<div class="mpfy-flex">\
						...
						<div class="mpfy-flex-column" style="min-width: 80px; width: 10%;">\
							<div class="mpfy-flex-column-contents">\
								...
								<div class="carbon-field">' + settings.map_id + '</div>\
							</div>\
						</div>\
						<div class="mpfy-flex-column" style="width: 41%;">\
							<div class="mpfy-flex-column-contents">\
								<label>' + shortcodeLabel + ' <em class="help-text">' + shortcodeClarificationLabel + '</em></label>\
								<div class="carbon-field">' + settings.shortcode + '</div>\
							</div>\
						</div>\
					</div>\
				' );
			...
			for (var group in groups) {
				...
				var $helpText = $firstFieldContainer.find( '.help-text:first' );
