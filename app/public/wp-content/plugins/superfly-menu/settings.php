...
function sf_fa_on_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_fa_on'] ) && $options['sf_fa_on'] ? 'checked="checked"' : '';
...
function sf_transition_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_transition'] ) && $options['sf_transition'] ? 'checked="checked"' : '';
...
function sf_hide_def_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_hide_def'] ) && $options['sf_hide_def'] ? 'checked="checked"' : '';
...
function sf_sidebar_scale_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_sidebar_scale'] ) && $options['sf_sidebar_scale'] ? 'checked="checked"' : '';
...
function sf_label_invert_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_label_invert'] ) && $options['sf_label_invert'] ? 'checked="checked"' : '';
...
function sf_label_no_anim_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_label_no_anim'] ) && $options['sf_label_no_anim'] ? 'checked="checked"' : '';
...
function sf_fs_dynamic_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_fs_dynamic'] ) && $options['sf_fs_dynamic'] ? 'checked="checked"' : '';
...
function sf_ind_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_ind'] ) && $options['sf_ind'] ? 'checked="checked"' : '';
...
function sf_ordered_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_ordered'] ) && $options['sf_ordered'] ? 'checked="checked"' : '';
...
function sf_separators_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_separators'] ) && $options['sf_separators'] ? 'checked="checked"' : '';
...
function sf_highlight_active_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_highlight_active'] ) && $options['sf_highlight_active'] ? 'checked="checked"' : '';
...
function sf_label_vis_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_label_vis'] ) && $options['sf_label_vis'] ? 'checked="checked"' : '';
...
function sf_mob_nav_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_mob_nav'] ) && $options['sf_mob_nav'] ? 'checked="checked"' : '';
...
function sf_label_text_str () {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_label_text'] ) && $options['sf_label_text'] ? 'checked="checked"' : '';
...
function sf_submenu_support_str() {
	$options = sf_get_options();
    $first_checked = isset( $options['sf_submenu_support'] ) && $options['sf_submenu_support'] ? 'checked="checked"' : '';
...
function sf_video_preload_str() {
    $options = sf_get_options();
    $first_checked = isset( $options['sf_video_preload'] ) && $options['sf_video_preload'] ? 'checked="checked"' : '';
...
function sf_video_mob_str() {
    $options = sf_get_options();
    $first_checked = isset( $options['sf_video_mob'] ) && $options['sf_video_mob'] ? 'checked="checked"' : '';
...
function sf_parent_ignore_str() {
	$options = sf_get_options();
    $first_checked = isset( $options['sf_parent_ignore'] ) && $options['sf_parent_ignore'] ? 'checked="checked"' : '';
...
function sf_submenu_mob_str() {
	$options = sf_get_options();
	$first_checked = isset( $options['sf_submenu_mob'] ) && $options['sf_submenu_mob'] ? 'checked="checked"' : '';
